...
function Section1() {
  ...
  return (
    <section ref={sectionRef} className="text-center opacity-0">
      ...
      <h1 className="text-colorWhite-0 font-calibreSemBold text-5xl md:text-7xl font-semibold">
        Vincent Vinuya
      </h1>
      <h1 className="text-colorgray-0 font-calibreSemBold md:text-7xl mb-5 text-5xl font-semibold">
        Aspiring Web Developer
      </h1>
      <p className="font-calibreReg md:text-xl text-base w-[16rem] md:w-[27rem] mx-auto text-colorWhite-0 mb-5 font-normal">
